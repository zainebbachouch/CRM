                ...
                <div className="loginInput mt-4">
                    ...
                    <p className='loginMessage text-center text-center'>or login using your email</p>
                        ...
                        <div className="form-group mt-1">
                            ...
                            <label for="passwordInput" className='text-muted'>Password</label>
                        ...
                        <p className='text-center mt-2'> you don't have an account ? <span className="signupMessage">Sign up</span> </p>
                </div>
            </div>
        </div>
    </div>
